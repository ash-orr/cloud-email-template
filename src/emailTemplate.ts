        ...
        <tr>
          <td align="center" style="padding:28px 12px;">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="760" style="width:760px;max-width:760px;background-color:#ffffff;border:1px solid #d8e0ea;border-radius:14px;border-collapse:collapse;">
              <tr>
                <td style="padding:18px 24px;border-bottom:1px solid #d8e0ea;background-color:#0b4a53;font-family:'Open Sans',Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;font-weight:600;color:#ffffff;">
                  Portnox Cloud
                </td>
              </tr>
              <tr>
                <td style="padding:30px 24px 10px;font-family:'Open Sans',Arial,Helvetica,sans-serif;color:#171d26;">
                  <h1 style="margin:0 0 14px;font-size:22px;line-height:33px;font-weight:600;color:#171d26;">Welcome to Portnox Cloud - let's complete your setup.</h1>
                  <p style="margin:0 0 12px;font-size:14px;line-height:21px;font-weight:400;color:#566273;">To gain access to your {{organizationName}} Portnox Cloud organization, please verify your mail domain below.</p>
                  ...
                  <p style="margin:0 0 8px;font-size:12px;line-height:18px;font-weight:400;color:#6f7f91;">This verification link expires in 48 hours. If you did not initiate this request, no action is required.</p>
                </td>
              </tr>
              <tr>
                <td style="padding:18px 24px 8px;border-top:1px solid #d8e0ea;font-family:'Open Sans',Arial,Helvetica,sans-serif;">
                  <p style="margin:0 0 12px;font-size:14px;line-height:21px;font-weight:600;letter-spacing:0;text-transform:uppercase;color:#171d26;">Helpful resources</p>
                  <p style="margin:0 0 8px;font-size:14px;line-height:21px;font-weight:400;"><a href="https://docs.portnox.com/topics/quick_start" target="_blank" style="color:#007c96;text-decoration:underline;">Quick Start Guide</a> | <a href="https://success.portnox.com/s/" target="_blank" style="color:#007c96;text-decoration:underline;">Support Center</a> | <a href="https://docs.portnox.com/?utm_medium=website&utm_source=home" target="_blank" style="color:#007c96;text-decoration:underline;">Learn more</a> | <a href="https://www.portnox.com/resources/" target="_blank" style="color:#007c96;text-decoration:underline;">Blog and Best Practices</a></p>
                  <p style="margin:8px 0 0;font-size:12px;line-height:18px;font-weight:400;color:#566273;">For assistance, contact our support team at <a href="mailto:support@portnox.com" style="color:#007c96;text-decoration:underline;">support@portnox.com</a> or visit the <a href="https://success.portnox.com/s/" target="_blank" style="color:#007c96;text-decoration:underline;">Support Portal</a>.</p>
                </td>
              </tr>
              <tr>
                <td style="padding:14px 24px 18px;border-top:1px solid #d8e0ea;font-family:'Open Sans',Arial,Helvetica,sans-serif;font-size:12px;line-height:18px;color:#6f7f91;">© 2026 Portnox | Access Layers, all rights reserved.<br /><a href="https://www.portnox.com/privacy-policy" target="_blank" style="color:#007c96;text-decoration:underline;">Privacy Policy</a> · <a href="https://www.portnox.com/terms-of-service" target="_blank" style="color:#007c96;text-decoration:underline;">Terms of Service</a></td>
              </tr>
            </table>
          </td>
        </tr>
